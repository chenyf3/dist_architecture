package com.xpay.gateway.api.config.conts;
...
public class FilterOrder {
    //从-50到-31是非业务相关的前置请求全局过滤器，如：黑名单过滤器
    ...
    //从-30到-15是对请求体做相应处理的全局过滤器
    public final static int REQUEST_READ_FILTER = -30; //读取请求体内容，并缓存
    public final static int REQUEST_PARAM_CHECK_FILTER = -29; //请求参数校验
    public final static int REQUEST_IP_VALID_FILTER = -28;  //请求参数签名验证
    public final static int REQUEST_AUTH_FILTER = -27;  //请求参数签名验证
    public final static int REQUEST_LIMIT_FILTER = -26;  //限流过滤器
    public final static int REQUEST_MODIFY_FILTER = -25; //修改请求体
    public final static int REWRITE_PATH_FILTER = -24; //根据请求参数中method的值修改请求uri
