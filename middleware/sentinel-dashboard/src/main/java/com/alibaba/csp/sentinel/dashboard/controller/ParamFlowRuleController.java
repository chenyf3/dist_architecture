...
public class ParamFlowRuleController {
    ...
    public Result<List<ParamFlowRuleEntity>> apiQueryAllRulesForMachine(@RequestParam String app,
        ...
        try {
            List<ParamFlowRuleEntity> rules = syncRules(app);
    ...
    public Result<ParamFlowRuleEntity> apiAddParamFlowRule(@RequestBody ParamFlowRuleEntity entity) {
        ...
        try {
            //先从配置中心同步配置，避免因为dashboard数据没同步而造成配置被覆盖
            syncRules(entity.getApp());
    ...
    private boolean publishRules(String app, String ip, Integer port) throws Exception {
        ...
        try {
            ...
            logger.error("发布 paramFlowRule 异常, app: {}", app, e);
            return false;
        }
    }

    private List<ParamFlowRuleEntity> syncRules(String app) throws Exception {
