...
public class JsonUtil {
	 ...
	 * @return
	 */
	public static final String toJson(Object obj, SerializerFeature... feature) {
	 ...
	 * @return
	 */
	public static final String toJsonWithNull(Object obj) {
	 ...
	 * @return
	 */
	public static final String toJsonFriendly(Object obj) {
	...
	public static final String toJsonFriendlyNotNull(Object obj) {
		SerializeConfig config = new SerializeConfig();
		config.put(Long.class, new StringSerializer());
		config.put(Date.class, new SimpleDateFormatSerializer("yyyy-MM-dd HH:mm:ss"));
	 ...
	 * @return
	 */
	public static String toJsonUnderline(Object obj){
