package com.xpay.demo.sentinel.web.config;
...
@ConditionalOnClass({
        com.alibaba.csp.sentinel.adapter.spring.webmvc.callback.BlockExceptionHandler.class,
...
public class SentinelAutoConfiguration {
    ...
    /**
     * 配置一个全局的 BlockExceptionHandler，用以替换默认使用的 DefaultBlockExceptionHandler
     * @return
     */
    @Bean
