...
public class RSAUtil {
     ...
     * @throws SDKException
     */
    public static String sign(String cleartext, String priKeyBase64) throws SDKException {
        try {
     ...
     * @throws SDKException
     */
    public static String sign(byte[] data, String priKeyBase64) throws SDKException {
        try {
     ...
     * @throws SDKException
     */
    public static boolean verify(String cleartext, String pubKeyBase64, String signStrBase64) throws SDKException {
        try {
            byte[] dataBytes = cleartext.getBytes(StandardCharsets.UTF_8);
     ...
     * @throws SDKException
     */
    public static boolean verify(byte[] data, String pubKeyBase64, String signStrBase64) throws SDKException {
        try {
    ...
    public static Map<String, String> genKeyPair() throws SDKException {
        try {
            ...
            keyPairGen.initialize(KEY_SIZE_RSA2);
            ...
            throw new RuntimeException("生成RSA密钥对出现异常", e);
        }
    }
