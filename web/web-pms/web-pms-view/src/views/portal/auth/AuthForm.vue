    ...
    >
        <el-form ref="form" :inline="true" :model="form" :rules="rules" size="small" label-width="100px">
            ...
            <el-form-item label="权限名称" prop="name">
                <el-input v-model.trim="form.name" placeholder="权限/菜单名称"/>
            </el-form-item>
            <el-form-item label="权限标识" prop="permissionFlag">
                <el-input v-model.trim="form.permissionFlag" placeholder="前后端共用的权限标识"/>
            </el-form-item>
            <el-form-item label="URL地址" prop="url">
                <el-input v-model.trim="form.url" placeholder="前端菜单router路径" :disabled="form.authType === 2"/>
            </el-form-item>
            <el-form-item label="菜单图标" prop="icon">
                <e-icon-picker v-model="form.icon" placeholder="点击选择图标" :disabled="form.authType === 2"/>
            </el-form-item>
            <el-form-item label="排序编号" prop="number">
                <el-input v-model.trim="form.number" placeholder="菜单排序编号"/>
            </el-form-item>
        </el-form>
...
<script>
import {addAuth, editAuth} from '@/api/portal/auth';
...
export default {
    ...
    data() {
        return {
            ...
            rules: {
                authType: [{required: true, message: '请选择权限类型', trigger: 'blur'}],
