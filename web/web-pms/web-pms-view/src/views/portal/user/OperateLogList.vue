    ...
    <div v-loading="loading" class="app-container">
        <el-form :inline="true" size="small">
            ...
            <el-form-item label="商户编号">
                <el-input v-model="searchForm.mchNo" placeholder="精确匹配"/>
            </el-form-item>
            <el-form-item label="操作用户">
                <el-input v-model="searchForm.loginName" placeholder="精确匹配"/>
            </el-form-item>
            <el-form-item>
        ...
        <div class="">
            <el-table border :data="pageResult.data">
                ...
                <el-table-column prop="mchNo" label="商户编号" sortable />
...
import {listOperateLog} from '@/api/portal/user'

export default {
    name: 'PortalOperateLogList',
    components: {
        Pagination
    },
    data() {
