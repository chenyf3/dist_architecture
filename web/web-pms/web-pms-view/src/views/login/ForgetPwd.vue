  ...
  <div class="forget-login-pwd">
    <div class="forget-login-pwd-box" v-loading="formLoading">
      ...
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="120px">
        ...
        <el-form-item v-if="showFindPwdInfo" label="新密码" prop="newPwd">
          <el-input v-model="ruleForm.newPwd" type="password" placeholder="请输入新密码"></el-input>
        </el-form-item>
        <el-form-item v-if="showFindPwdInfo" label="确认密码" prop="confirmPwd">
          <el-input v-model="ruleForm.confirmPwd" type="password" placeholder="请确认新密码"></el-input>
        </el-form-item>
        <el-form-item>
        ...
        if (valid) {
          ...
          retrieveLoginPwd({
            ...
            .then(res => {
              this.formLoading = false;
              if (res.code === 200) {
                this.$message.success('密码找回成功，请使用新密码登录');
